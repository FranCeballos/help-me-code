export const resetEmailHTML = (title, buttonText, link, prevTitle) => {
  ...
  <![endif]-->
    ...
    <![endif]-->
      ...
      <tbody>
        <tr>
          <td style="padding:15px 5px 10px 95px; line-height:12px; text-align:inherit; background-color:#064962;" height="100%" valign="top" bgcolor="#064962" role="module-content"><div><div style="font-family: inherit; text-align: right"><span style="font-size: 10px; color: #ffffff">C3 Plus</span></div><div></div></div></td>
        </tr>
      </tbody>
      ...
      <tbody>
        <tr>
          <td style="font-size:6px; line-height:10px; padding:40px 0px 20px 0px;" valign="top" align="center">
            <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px; max-width:20% !important; width:20%; height:auto !important;" width="64" alt="" data-proportionally-constrained="true" data-responsive="true" src="http://cdn.mcauto-images-production.sendgrid.net/af78c5bd7508a606/39717d41-9f1f-4ed8-a23f-211112ebc62d/299x283.png">
          </td>
        </tr>
      </tbody>
    </table></td>
      ...
      <tbody>
        <tr>
          <td style="padding:30px 0px 10px 0px; line-height:10px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><h1 style="text-align: center; font-family: inherit"><span style="font-family: &quot;arial black&quot;, helvetica, sans-serif; color: #064962; font-size: 24px">${title}</span></h1><div></div></div></td>
        </tr>
      </tbody>
          ...
          <tr>
            <td align="center" bgcolor="" class="outer-td" style="padding:0px 0px 0px 0px;">
              <table border="0" cellpadding="0" cellspacing="0" class="wrapper-mobile" style="text-align:center;">
                <tbody>
                  <tr>
                  <td align="center" bgcolor="#064962" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;"><a href=${link} style="background-color:#064962; border:0px solid #333333; border-color:#333333; border-radius:0px; border-width:0px; color:#ffffff; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 30px 12px 30px; text-align:center; text-decoration:none; border-style:solid; font-family:arial black, helvetica, sans-serif;" target="_blank">${buttonText}</a></td>
                  </tr>
                </tbody>
              </table>
            </td>
      ...
      </table><div data-role="module-unsubscribe" class="module" role="module" data-type="unsubscribe" style="color:#ffffff; font-size:10px; line-height:20px; padding:150px 16px 16px 16px; text-align:Center;" data-muid="4e838cf3-9892-4a6d-94d6-170e474d21e5"><div class="Unsubscribe--addressLine"></div></div><table class="module" role="module" data-type="spacer" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="8a8500f7-1498-4352-ba24-d2cc764127e6">
      <tbody>
        <tr>
